...
///<reference path="../../libs/domo.js"/>

describe("Render paragraphs", () => {

    it("can render paragraph with links", () => {

        var renderThis =
        P({},
            "dōmo lets you write ",
            A({ href: "#html" }, "HTML markup"),
            " and ", A({ href: "#css" }, "CSS styles"),
            " in JavaScript syntax, in the browser and ",
            A({ href: "#server" }, "on the server"), ". ",
